...
export default function WildlifeTabs() {
  ...
  return (
    <div className="tabs-container relative p-3 h-auto w-10/12 m-auto bg-stone-300 rounded min-h-[30rem] flex flex-col justify-center items-center mt-[8rem] ">
      <div className="absolute top-0 w-auto bg-stone-800 p-5 flex flex-row gap-1 rounded-b-lg shadow-md">
      ...
      <div
        className={`flex flex-col gap-5 m-auto h-auto py-4`}
      >
        <div
          className={`${activeTab !== "bears" && "hidden"} flex flex-row justify-center gap-6 `}
        >
        ...
        <div className={`${activeTab !== "other" && "hidden"} flex flex-row gap-6 justify-center`}>
          <p className="w-1/2 justify-start ">
